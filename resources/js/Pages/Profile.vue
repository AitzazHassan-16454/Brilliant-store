...
<div class="min-h-screen bg-[#FAF7F2] dark:bg-[#0A0A0A] text-[#1A1A1A] dark:text-[#F5F5F5]" style="font-family:'Inter',system-ui,sans-serif;">
  ...
  <motion.div
    ...
    class="bg-white/60 dark:bg-[#1A1A1A] border-b border-gray-200 dark:border-[#D4AF37]/20 shadow-sm"
  >
  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    >
      ...
      <motion.div :variants="m.itemFadeUp(0)" :whileHover="{ y: -4, transition: m.spring.gentle }"
        class="rounded-2xl p-6 flex items-center justify-between transition-all duration-300 border border-gray-200 dark:border-[#D4AF37]/20 bg-white dark:bg-[#1A1A1A]/60 shadow-xl">
        <div>
      ...
      <motion.div :variants="m.itemFadeUp(1)" :whileHover="{ y: -4, transition: m.spring.gentle }"
        class="rounded-2xl p-6 flex items-center justify-between transition-all duration-300 border border-gray-200 dark:border-[#D4AF37]/20 bg-white dark:bg-[#1A1A1A]/60 shadow-xl">
        <div>
      ...
      <motion.div :variants="m.itemFadeUp(2)" :whileHover="{ y: -4, transition: m.spring.gentle }"
        class="rounded-2xl p-6 flex items-center justify-between transition-all duration-300 border border-gray-200 dark:border-[#D4AF37]/20 bg-white dark:bg-[#1A1A1A]/60 shadow-xl">
        <div>
    ...
    <motion.p
      ...
      :transition="{ delay: 0.2, duration: 0.4, ease: m.easeOutExpo }"
      class="text-xs font-bold uppercase tracking-widest mb-4 text-gray-400 dark:text-[#A0A0A0]">Quick Actions</motion.p>

    <motion.div
      :variants="m.staggerContainer(0.07, 0.03)"
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <Motion
        asChild
        :variants="m.itemFadeUp(0)"
        :whileHover="{ y: -6, boxShadow: '0 12px 40px rgba(212,175,55,0.15)', transition: m.spring.gentle }"
      >
        <Link
          href="/cart"
          class="group rounded-2xl p-5 transition-all duration-300 no-underline border border-gray-200 dark:border-[#D4AF37]/20 bg-white dark:bg-[#1A1A1A]/60 shadow-xl block h-full">
